...
import { ComputeBudgetProgram,Keypair,Connection,Transaction,PublicKey,SystemProgram } from '@solana/web3.js';
...
const sqlite=new DatabaseSync(':memory:');sqlite.exec(readFileSync('drizzle/0000_lush_the_executioner.sql','utf8'));sqlite.exec(readFileSync('drizzle/0001_secure_atomic_split.sql','utf8'));
