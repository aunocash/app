...
const readyRoute = await readFile(new URL("../app/api/ready/route.ts", import.meta.url), "utf8");
...
assert.ok(compose.includes("http://127.0.0.1:3000/api/ready"));
...
assert.match(readyRoute, /ready: true/);
