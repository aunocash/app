...
const recipients = [
  { amount: '80', role: 'Olivia Bennett', color: '#fd6c03', route: 'M300 204 C300 254 100 242 100 306' },
  { amount: '15', role: 'Noah Williams', color: '#fd6c03', route: 'M300 204 L300 306' },
  { amount: '5', role: 'Ava Mitchell', color: '#fd6c03', route: 'M300 204 C300 254 500 242 500 306' },
];

export function SplitFlow() {

  return (
    <figure className="split-flow" aria-label="Illustration: one payment of 100 USDC enters AUNO and splits into 80 USDC for Olivia Bennett, 15 USDC for Noah Williams, and 5 USDC for Ava Mitchell.">
        ...
        <div className="sf-routing">
          ...
          <svg className="sf-paths" viewBox="0 0 600 310" preserveAspectRatio="none" aria-hidden="true">
            ...
            <g className="sf-incoming-packet" opacity="0">
              <circle className="sf-packet-halo" r="10" fill="#fd6c03" opacity=".16" /><circle className="sf-packet-core" r="4.5" fill="#fd6c03" />
              <animateMotion path="M300 84 L300 140" dur="5.6s" keyPoints="0;0;1;1" keyTimes="0;.06;.30;1" calcMode="linear" repeatCount="indefinite" />
              <animate attributeName="opacity" values="0;1;1;0;0" keyTimes="0;.05;.28;.32;1" dur="5.6s" repeatCount="indefinite" />
            </g>
            {recipients.map((r, index) => <g key={r.role} className="sf-outgoing-packet" opacity="0">
              <circle className="sf-packet-halo" r="10" fill={r.color} opacity=".16" /><circle className="sf-packet-core" r="4.5" fill={r.color} />
              <animateMotion path={r.route} dur="5.6s" begin={index * .22 + 's'} keyPoints="0;0;1;1" keyTimes="0;.36;.78;1" calcMode="linear" repeatCount="indefinite" />
              <animate attributeName="opacity" values="0;0;1;1;0;0" keyTimes="0;.34;.38;.76;.80;1" dur="5.6s" begin={index * .22 + 's'} repeatCount="indefinite" />
            </g>)}
