...
export function Nav() {
  ...
  return <header className="nav"><Brand /><button className="menu" aria-label="Toggle navigation" aria-expanded={open} onClick={() => setOpen(!open)}>Menu</button><nav className={open ? "open" : ""}><a href="/#product">Product</a><a href="/developers">Developers</a><a href="/docs">Docs</a><a href="/roadmap">Roadmap</a><a className="button small" href="/dashboard/create">Try on Devnet <LaunchIcon /></a></nav></header>;
}

export function Footer() {
  return <footer><div><Brand /><p>Programmable Payments on Solana.</p><small>No mainnet payments · Not audited</small></div><div><a href="/#product">Product</a><a href="/developers">Developers</a><a href="/docs">Documentation</a><a href="/whitepaper">Whitepaper</a><a href="/roadmap">Roadmap</a></div><div className="footer-bottom"><span>© 2026 AUNO</span><span>Value in motion.</span><span>Designed for auno.cash</span></div></footer>;
}

export function Flow() {
  return <div className="flow" aria-hidden="true"><div className="wash w1" /><div className="wash w2" /><svg viewBox="0 0 1200 760" preserveAspectRatio="xMidYMid slice"><defs><linearGradient id="line"><stop stopColor="#ffd1b0" stopOpacity="0" /><stop offset=".48" stopColor="#f08a4b" stopOpacity=".5" /><stop offset="1" stopColor="#e6b18e" stopOpacity="0" /></linearGradient><path id="flow-a" d="M-100 640C220 610 340 95 620 240S950 600 1320 100" /><path id="flow-b" d="M-100 690C240 580 300 100 640 280S1000 480 1330 200" /><path id="flow-c" d="M620 240C900 370 920 650 1300 600" /></defs><g fill="none" stroke="url(#line)"><use href="#flow-a" /><use href="#flow-b" /><use href="#flow-c" /></g>{["flow-a", "flow-b", "flow-c"].map((path, index) => <circle key={path} r="3.5" fill="#e8752b"><animateMotion dur={`${12 + index * 4}s`} repeatCount="indefinite"><mpath href={`#${path}`} /></animateMotion></circle>)}</svg></div>;
}
