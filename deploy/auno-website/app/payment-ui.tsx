    ...
    <AppShell title="Create a payment." subtitle="Define the amount. Choose the destination. Share one link.">
      <div className="app-grid">
        ...
        <aside>
          ...
          <a className="text-link" href="/docs#getting-started">How to get devnet test assets →</a>
        </aside>
      </div>
    </AppShell>
  );
