...
export function Flow() {
  return <div className="flow" aria-hidden="true"><div className="wash w1" /><div className="wash w2" /><svg viewBox="0 0 1200 760" preserveAspectRatio="xMidYMid slice"><defs><linearGradient id="line"><stop stopColor="#ffb075" stopOpacity="0" /><stop offset=".48" stopColor="#e98940" stopOpacity=".5" /><stop offset="1" stopColor="#adb9d4" stopOpacity="0" /></linearGradient><path id="flow-a" d="M-100 640C220 610 340 95 620 240S950 600 1320 100" /><path id="flow-b" d="M-100 690C240 580 300 100 640 280S1000 480 1330 200" /><path id="flow-c" d="M620 240C900 370 920 650 1300 600" /></defs><g fill="none" stroke="url(#line)"><use href="#flow-a" /><use href="#flow-b" /><use href="#flow-c" /></g>{["flow-a", "flow-b", "flow-c"].map((path, index) => <circle key={path} r="3.5" fill="#fd6c03"><animateMotion dur={`${12 + index * 4}s`} repeatCount="indefinite"><mpath href={`#${path}`} /></animateMotion></circle>)}</svg></div>;
}
